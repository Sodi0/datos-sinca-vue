        ...
        <div
            ...
            <div class="mx-auto max-w-4xl text-center">
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a class="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white px-8 py-4 font-semibold text-gray-700 shadow-sm transition-all hover:border-[#535bf2] hover:bg-gray-50 hover:text-[#535bf2]"
                        href="/mapa">
